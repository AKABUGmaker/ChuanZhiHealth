...
public class QiniuUtil {
    //七牛给你分配账号密码
    static String accessKey = "ydCKuZ_lCBu1thV-qOG2E3FBxELxDz7rByGWqgEK";
    static String secretKey = "maRdD2Dg1KikIi2xPpwntwCGA6IV_JtfxaFdNsOi";
    //自己创建的存储空间名称
    static String bucket = "heima86health";
